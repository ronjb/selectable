...
extension _ExtOnIterableOfRect on Iterable<Rect> {
  ...
  List<Rect> mrtl() => mergedToSelectionRectsRtl();
}
...
void main() {
  ...
  test('mergedToSelectionRectsRtl', () {
    var rects = [r(0, 0, 1, 1)];
    expect(rects.mrtl(), [r(0, 0, 1, 1)]);
    ...
    // 2   └┘        └┘
    rects = [r(0, 0, 1, 1), r(2, 1, 3, 2)];
    expect(rects.mrtl(), [r(0, 0, 1, 1), r(2, 1, 3, 2)]);
    ...
    // 3     └┘           └┘
    rects = [r(0, 0, 1, 1), r(2, 1, 3, 2), r(4, 2, 5, 3)];
    expect(rects.mrtl(), [r(0, 0, 1, 1), r(0, 1, 5, 2), r(4, 2, 5, 3)]);
    ...
    // 3 └┘           └────┘
    rects = [r(4, 0, 5, 1), r(2, 1, 3, 2), r(0, 2, 1, 3)];
    expect(rects.mrtl(), [r(0, 0, 5, 1), r(0, 1, 5, 2), r(0, 2, 5, 3)]);
    ...
    // 6       └┘            └┘
    rects = [r(0, 0, 1, 1), r(2, 0, 3, 5), r(4, 4, 5, 5), r(6, 5, 7, 6)];
    expect(rects.mrtl(), [r(0, 0, 5, 5), r(6, 5, 7, 6)]);
    ...
    // 5   └┘└┘          └────┘
    rects = [r(0, 0, 1, 1), r(2, 4, 3, 5), r(4, 1, 5, 5), r(6, 1, 7, 2)];
    expect(rects.mrtl(), [r(0, 0, 1, 1), r(2, 1, 7, 5)]);
  });
}
